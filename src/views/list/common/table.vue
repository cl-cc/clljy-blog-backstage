...
<template>
  <div>
    ...
    <el-table :data="list" stripe row-key="id" style="width: 100%">
      <el-table-column prop="street_name" label="文章名称" align="center" />
      <el-table-column prop="recover_num" label="发布时间" align="center" />
      <el-table-column prop="coverage_num" label="阅读数量" align="center" />
      <el-table-column prop="coverage_num" label="文章类型" align="center" />
      <el-table-column prop="coverage_num" label="文章内容" align="center" />
